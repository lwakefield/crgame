...
lib LibRay
  ...
  fun begin_2d_mode = BeginMode2D(camera : Camera2D) : Void
  fun end_2d_mode = EndMode2D : Void
  fun begin_3d_mode = BeginMode3D(camera : Camera) : Void
  fun end_3d_mode = EndMode3D : Void
